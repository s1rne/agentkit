...
`0.5.0` — ранняя версия. Конструкция целая и покрыта тестами, но ядро ещё не проверено выпуском реального продукта. Протоколы, скорее всего, ужмутся при встрече с настоящей работой.
