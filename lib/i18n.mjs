...
const en = {
  ...
  capacityLine: (c) => `${c.cores} cores · ${c.ramAvailGB} of ${c.ramTotalGB} GB RAM free · ${c.diskFreeGB} GB disk free · load ${c.load1}`,
...
const ru = {
  ...
  capacityLine: (c) => `${c.cores} ядер · ${c.ramAvailGB} из ${c.ramTotalGB} ГБ RAM свободно · ${c.diskFreeGB} ГБ на диске · нагрузка ${c.load1}`,
